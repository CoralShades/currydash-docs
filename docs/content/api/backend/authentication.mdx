...
<Tabs items={['PHP/Laravel', 'Dart/Flutter', 'cURL']}>
  ...
  <Tabs.Tab>
    ...
    Future<Map<String, dynamic>> login({
      ...
      try {
        final response = await http.post(
          Uri.parse('https://api.currydash.au/api/v1/auth/login'),
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
          },
...
<Tabs items={['PHP/Laravel', 'Dart/Flutter', 'cURL']}>
  ...
  <Tabs.Tab>
    ...
    Future<Map<String, dynamic>> forgotPassword({
      ...
      try {
        final response = await http.post(
          Uri.parse('https://api.currydash.au/api/v1/auth/forgot-password'),
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
          },
        ...
        if (response.statusCode == 200) {
          ...
          // In development, OTP may be returned in response
          // In production, OTP is only sent via email/SMS
          final message = data['message'] ?? 'Password reset OTP sent successfully';

          return {
            'success': true,
            'message': message,
            if (data['otp'] != null) 'otp': data['otp'], // Only in development
          };
        }
    ...
    Future<Map<String, dynamic>> resetPassword({
      ...
      try {
        final response = await http.put(
          Uri.parse('https://api.currydash.au/api/v1/auth/reset-password'),
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
          },
        ...
        debugPrint('Reset password request failed: $e');
  ...
  <Tabs.Tab>
    ...
    Future<Map<String, dynamic>> refreshToken() async {
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse('https://api.currydash.au/api/v1/auth/refresh'),
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
          },
...
<Tabs items={['PHP/Laravel', 'Dart/Flutter', 'cURL']}>
  ...
  <Tabs.Tab>
    ...
    Future<Map<String, dynamic>> makeAuthenticatedRequest({
      ...
      try {
        final uri = Uri.parse('https://api.currydash.au$endpoint');
        final headers = {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
        ...
        if (response.statusCode == 401) {
          ...
          if (refreshResult['success'] == true) {
            ...
            final retryResponse = method == 'GET'
                ? await http.get(uri, headers: retryHeaders)
                : await http.post(uri, headers: retryHeaders, body: jsonEncode(data ?? {}));
        ...
        debugPrint('Authenticated request failed: $endpoint - $e');
...
<Tabs items={['Mobile Apps', 'Web Apps', 'Token Storage']}>
  <Tabs.Tab>
    ```dart
    // Flutter - Automatically refresh before token expiration
    import 'dart:async';
    ...
    void scheduleTokenRefresh(int expiresIn) {
      ...
      _tokenRefreshTimer = Timer(refreshTime, () async {
        ...
        if (result['success'] == true) {
          final newExpiresIn = result['expires_in'] ?? 86400;
          scheduleTokenRefresh(newExpiresIn);
        } else {
          // Refresh failed, require re-login
          debugPrint('Token refresh failed, user needs to re-login');
          // Navigate to login screen or show re-authentication dialog
        }
      });
    }

    // Call after login or token refresh
    void onAuthenticationSuccess(int expiresIn) {
  ...
  <Tabs.Tab>
    ...
    - **Flutter**: Use `flutter_secure_storage` package for encrypted storage on both platforms
  </Tabs.Tab>
</Tabs>
