...
**Version**: 2.1
**Last Updated**: January 22, 2026 (Documentation migration & modernization)
...
7. [Cultural Context](#cultural-context)
...
- **Hex**: `#C5351F`
- **RGB**: `rgb(197, 53, 31)`
- **Usage**: Accent color, urgency indicators, spice level badges, promotions
...
- **Hex**: `#4A7C59`
- **RGB**: `rgb(74, 124, 89)`
- **Usage**: Trust indicators, healthy options, sustainability messaging, success states
...
- **Hex**: `#FFF8DC`
- **RGB**: `rgb(255, 248, 220)`
- **Usage**: Light mode backgrounds, cards, surfaces
...
- **Hex**: `#4CAF50`
- **RGB**: `rgb(76, 175, 80)`
- **Usage**: Success messages, confirmations, delivered orders
...
- **Hex**: `#E53935`
- **RGB**: `rgb(229, 57, 53)`
- **Usage**: Error states, critical alerts, failed actions
...
- **Mobile**: < 600px (Flutter: `ResponsiveHelper.isMobile()`)
- **Tablet**: 600px - 1024px (Flutter: `ResponsiveHelper.isTab()`)
- **Desktop**: > 1024px (Flutter: `ResponsiveHelper.isDesktop()`)
- **Web**: Browser platforms (Flutter: `ResponsiveHelper.isWeb()`)
...
### Text Scalability
- All text sizes use `sp` (scaled pixels) in Flutter
...
**Vesak (May)**: Accent with golden yellow (#F9A825) and white
**Sinhala/Tamil New Year (April)**: Incorporate traditional patterns in brand colors
**Deepavali (Oct/Nov)**: Warm orange (#FF9800) and gold accents allowed
...
**Phase 1**: Create new color constants file
**Phase 2**: Update theme files to use new colors
**Phase 3**: Gradually refactor components (17+ files identified)
**Phase 4**: Remove deprecated legacy color constants
**Phase 5**: Test across all platforms and color modes
...
**Brand Guidelines Ownership**: Marketing & Design Team
**Technical Implementation**: Engineering Team
**Cultural Consultation**: Sri Lankan Community Advisory Board (proposed)
