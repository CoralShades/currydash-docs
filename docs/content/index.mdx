...
|------------|---------|--------------|
| [CurryDash-Admin-Seller-Portal](https://github.com/CoralShades/CurryDash-Admin-Seller-Portal) | Backend API & Admin Portal | Laravel 9.x+, MySQL 8.0, Redis |
| [CurryDash-UserApp-Mobile_Web-Flutter](https://github.com/CoralShades/CurryDash-UserApp-Mobile_Web-Flutter) | Customer Mobile & Web Apps | Flutter 3.x, Dart |
| [currydash-docs](https://github.com/CoralShades/currydash-docs) | Platform Documentation | Nextra 4, Next.js 15 |
